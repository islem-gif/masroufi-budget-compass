              ...
              <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium" style={{ textAlign: "left" }}>Téléphone</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium" style={{ textAlign: "left" }}>Email</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium" style={{ textAlign: "left" }}>Adresse</p>
